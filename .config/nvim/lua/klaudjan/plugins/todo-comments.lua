return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<leader>tdt", "<cmd>TodoTelescope<cr>",
      { desc = 'List all todo-comments keywords in Telescope' })
    vim.keymap.set("n", "<leader>tdq", "<cmd>TodoQuickFix<cr>",
      { desc = 'List all todo-comments keywords in QuickFix window' })
    vim.keymap.set("n", "<leader>td", "<cmd>TodoTelescope keywords=TODO<cr>",
      { desc = 'List all TODO keywords in QuickFix window' })
